...
from mangacollec_api.author.entity.author_endpoint_entity import AuthorsEndpointEntity, AuthorEndpointEntity
...
from mangacollec_api.author.endpoint.author_endpoint_interface import (
    IAuthorsEndpoint,
)
...
class AuthorsEndpoint(IAuthorsEndpoint):
    ...
    def get_all_authors_v2(self) -> list[Author]:
        ...
        return AuthorsEndpointEntity.deserialize(result)
