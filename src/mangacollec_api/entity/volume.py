...
class Volume(Entity):
    ...
    def __init__(self, id: str, title: str | None, number: str, release_date: datetime, isbn: str  | None, asin: str | None, edition_id: str, possessions_count: int, not_sold: bool, image_url: str ):
        self.id: str = id
