...
from mangacollec_api.entity.entity import Entity


class Edition(Entity):

    def __init__(self, id: str, title: str, series_id: str, publisher_id: str, parent_edition_id: str | None, volumes_count: int, last_volume_number: int | None, commercial_stop: bool, not_finished: bool, follow_editions_count: int):
        self.id: str = id
