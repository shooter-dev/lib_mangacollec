...
from mangacollec.domain.repositories.job_repository_interface import \
    IJobRepository
from mangacollec.domain.repositories.kind_repository_interface import \
    IKindRepository
...
from mangacollec.domain.repositories.publisher_repository_interface import \
    IPublisherRepository
from mangacollec.domain.repositories.read_repository_interface import \
    IReadRepository
from mangacollec.domain.repositories.serie_repository_interface import \
    ISerieRepository
