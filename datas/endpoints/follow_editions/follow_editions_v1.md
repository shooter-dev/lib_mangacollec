...
method: POST
response_brut: datas/endpoints/follow_editions/follow_editions_v1.json
...
## Description
Permet de suivre ou de ne plus suivre une édition spécifique. Cet endpoint permet à un utilisateur de gérer son suivi d'éditions, ce qui lui permet de recevoir des notifications et de suivre les actualités liées à cette édition. L'opération s'effectue en utilisant un paramètre booléen pour suivre ou arrêter de suivre.
