...
class TestInMemoryAuthorRepository:
    ...
    def test_add_and_get_by_id(
        self, repository: InMemoryAuthorRepository, sample_author: Author
    ) -> None:
    ...
    def test_get_all_multiple_authors(
        self, repository: InMemoryAuthorRepository
    ) -> None:
        """Test de récupération de plusieurs auteurs."""
        author1 = Author(
            id="id1", name="Name1", first_name="First1", tasks_count=10
        )
        author2 = Author(id="id2", name="Name2", first_name=None, tasks_count=20)
        author3 = Author(
            id="id3", name="Name3", first_name="First3", tasks_count=30
        )
    ...
    def test_get_list_with_authors(
        self, repository: InMemoryAuthorRepository
    ) -> None:
        """Test de récupération de la liste simplifiée."""
        author1 = Author(
            id="id1", name="Kishimoto", first_name="Masashi", tasks_count=10
        )
    ...
    def test_clear(self, repository: InMemoryAuthorRepository) -> None:
        ...
        author = Author(
            id="test-id", name="Test", first_name="Author", tasks_count=1
        )
